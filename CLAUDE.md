...
>
> **Falta el acuerdo explícito del equipo** (tarea 0.1 de `asistente-fundaciones`). Se escribe acá para que la regla exista y sea revisable, no para darla por aprobada: mientras el checkbox siga abierto, el #14 es una enmienda propuesta y no una decisión tomada.
