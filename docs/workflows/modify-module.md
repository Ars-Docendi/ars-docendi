...
- Correr `dotnet test ArsDocendi.slnx` — todos verdes.
...
Branch `feature/modify-<x>-<short-description>`. Ver [`open-pr.md`](./open-pr.md). En el body listar explícitamente:
...
- **Breaking change → spec obligatoria**: escalar.
