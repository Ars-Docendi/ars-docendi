...
- Leer [`docs/architecture/module-anatomy.md`](../architecture/module-anatomy.md) y [`docs/architecture/dependency-graph.md`](../architecture/dependency-graph.md).
...
- Path:
  ...
  - `backend/src/Modules.<X>.Contracts/`
...
Crear directorios + archivos esqueleto siguiendo [`module-anatomy.md`](../architecture/module-anatomy.md):
...
Branch `feature/create-module-<x>`. Ver [`open-pr.md`](./open-pr.md).
