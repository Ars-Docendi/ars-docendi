...
- **Prometer almacenamiento fuera del flujo real**: toda carga de CV o documento pasa por la sesión de archivos del backend; la UI nunca persiste ni expone URI, bucket o clave interna de SeaweedFS.
