...
Las tablas muestran sus acciones como **botones directos** en la columna Acciones, sin menú kebab: `Button variant="ghost" size="sm"` para las acciones neutras ("Ver", "Editar", "Desactivar") y una **X roja** con `aria-label` para eliminar. Así lo hacen Mis pedidos, Períodos, Usuarios y Docentes.
