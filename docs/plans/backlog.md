...
Cada item: una línea con contexto suficiente para retomarlo en otro momento.

- [`<modulo>`] _(corto descripción)_ — _(por qué importa o quién lo pidió)_

## Items

_(vacío al iniciar el proyecto)_
